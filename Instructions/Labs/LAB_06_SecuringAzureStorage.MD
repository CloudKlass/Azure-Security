...
16. Under **Firewall and virtual networks** select **Enabled from selected virtual networks and IP addresses**.

17. Under **Virtual networks** , click the **+ Add existing virtual network** link. 
